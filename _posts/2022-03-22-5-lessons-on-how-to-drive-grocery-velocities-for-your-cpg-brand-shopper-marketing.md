...
<p style="text-align: center;"><strong><a class="button" href="{{ '/contact/' | relative_url }}">TELL ME MORE</a></strong></p>
...
<img alt="shopper marketing tactics" class="fl-photo-img wp-image-2507 jetpack-lazy-image post-content-image" height="434" itemprop="image" src="{{ '/assets/images/blog/Shopper-Marketing-Tactics.png' | relative_url }}" title="Shopper Marketing Tactics" width="800"/>
